...
namespace Cosmos.System.FileSystem.SFS
{
    public class SimpleFS : FileSystem
    {
        ...
        public override void DisplayFileSystemInfo()
        {
            ...
            CustomConsole.WriteLineInfo("Checksum              = " + SuperBlock.Checksum);
            CustomConsole.WriteLineInfo("Continuations         = " + SuperBlock.Continuations);
            CustomConsole.WriteLineInfo("Data Size In Blocks   = " + SuperBlock.DataSizeInBlocks);
            CustomConsole.WriteLineInfo("EntryType             = " + SuperBlock.EntryType);
            CustomConsole.WriteLineInfo("Name                  = " + SuperBlock.Name);
            CustomConsole.WriteLineInfo("Size Of Index In Bytes= " + SuperBlock.SizeOfIndexInBytes);
            CustomConsole.WriteLineInfo("TimeStamp             = " + SuperBlock.TimeStamp);
            CustomConsole.WriteLineInfo("TotalBlocks           = " + SuperBlock.TotalBlocks);
            CustomConsole.WriteLineInfo("TotalReservedBlocks   = " + SuperBlock.TotalReservedBlocks);
            CustomConsole.WriteLineInfo("VersionNumber         = " + SuperBlock.VersionNumber);

            Global.mFileSystemDebugger.SendInternal("-------File System--------");
            Global.mFileSystemDebugger.SendInternal("BlockSize             = " + SuperBlock.BlockSize);
            Global.mFileSystemDebugger.SendInternal("Checksum              = " + SuperBlock.Checksum);
            Global.mFileSystemDebugger.SendInternal("Continuations         = " + SuperBlock.Continuations);
            Global.mFileSystemDebugger.SendInternal("Data Size In Blocks   = " + SuperBlock.DataSizeInBlocks);
            Global.mFileSystemDebugger.SendInternal("EntryType             = " + SuperBlock.EntryType);
            Global.mFileSystemDebugger.SendInternal("Name                  = " + SuperBlock.Name);
            Global.mFileSystemDebugger.SendInternal("Size Of Index In Bytes= " + SuperBlock.SizeOfIndexInBytes);
            Global.mFileSystemDebugger.SendInternal("TimeStamp             = " + SuperBlock.TimeStamp);
            Global.mFileSystemDebugger.SendInternal("TotalBlocks           = " + SuperBlock.TotalBlocks);
